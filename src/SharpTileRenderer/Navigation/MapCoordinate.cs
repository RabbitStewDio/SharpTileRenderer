...
{
    /// <summary>
    ///    Map coordinates describe the area of a single tile. The tile usually ranges
    ///    from [x - 0.5; x + 0.5) along both axes. 
    /// </summary>
    public readonly struct MapCoordinate : IEquatable<MapCoordinate>
    {
        ...
        public static MapCoordinate Normalize(float x, float y)
        {
