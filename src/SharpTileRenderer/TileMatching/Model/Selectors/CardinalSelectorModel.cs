...
{
    [DataContract]
    public class CardinalSelectorModel : ModelBase, ISelectorModel, IEquatable<CardinalSelectorModel>
    {
        [DataMember(Order = 0)]
        readonly string kind = BuiltInSelectors.Cardinal;
        ...
        {
            return other is CardinalSelectorModel m && Equals(m);
        }

        public bool Equals(CardinalSelectorModel? other)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((CardinalSelectorModel)obj);
        }
        ...
        public static bool operator ==(CardinalSelectorModel? left, CardinalSelectorModel? right)
        {
