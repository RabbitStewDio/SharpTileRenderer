...
{
    [DataContract]
    public class DiagonalSelectorModel : ModelBase, ISelectorModel, IEquatable<DiagonalSelectorModel>
    {
        [DataMember(Order = 0)]
        readonly string kind = BuiltInSelectors.Diagonal;
        ...
        {
            return other is DiagonalSelectorModel m && Equals(m);
        }

        public bool Equals(DiagonalSelectorModel? other)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((DiagonalSelectorModel)obj);
        }
        ...
        public static bool operator ==(DiagonalSelectorModel? left, DiagonalSelectorModel? right)
        {
