...
{
    [DataContract]
    public class RiverOutletSelectorModel : ModelBase, ISelectorModel, IEquatable<RiverOutletSelectorModel>
    {
        [DataMember(Order = 0)]
        readonly string kind = BuiltInSelectors.RiverOutlet;
        ...
        public RiverOutletSelectorModel()
        {
        ...
        {
            return other is RiverOutletSelectorModel m && Equals(m);
        }

        public bool Equals(RiverOutletSelectorModel? other)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((RiverOutletSelectorModel)obj);
        }
        ...
        public static bool operator ==(RiverOutletSelectorModel? left, RiverOutletSelectorModel? right)
        {
